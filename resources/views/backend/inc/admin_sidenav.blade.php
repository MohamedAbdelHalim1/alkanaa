                ...
                @canany(['add_new_product', 'show_all_products','show_in_house_products','show_seller_products','show_digital_products','product_bulk_import',
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endcan
                            @canany(['view_all_brands', 'brand_bulk_upload','view_all_partners'])
                                <li class="aiz-side-nav-item">
                                    <a href="javascript:void(0);" class="aiz-side-nav-link">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        ...
                                        @endcan
                                        @can('view_all_partners')
                                        <li class="aiz-side-nav-item">
                                            <a href="{{ route('partners.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['partners.index', 'partners.create', 'partners.edit'])}}">
                                                <span class="aiz-side-nav-text">{{translate('All Partners')}}</span>
                                            </a>
                                        </li>
                                        @endcan
